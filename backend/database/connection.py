        ...
        with self.get_connection() as conn:
            conn.executescript(
                ...
                CREATE TABLE IF NOT EXISTS sub_task_executions (
                    sub_task_execution_id INTEGER PRIMARY KEY AUTOINCREMENT,
                    ...
                    FOREIGN KEY (sub_task_id) REFERENCES sub_tasks(sub_task_id)
                );
                ...
                CREATE INDEX IF NOT EXISTS idx_sub_tasks_step ON sub_tasks(step_id, sub_task_order);
                CREATE INDEX IF NOT EXISTS idx_sub_task_exec ON sub_task_executions(execution_id, sub_task_id);
            """
            )

    def clear_data(self) -> None:
        with self.get_connection() as conn:
            conn.execute("DROP TABLE IF EXISTS sub_task_executions")
